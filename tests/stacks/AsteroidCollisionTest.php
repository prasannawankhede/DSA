...
class AsteroidCollisionTest extends TestCase
{
    public function testSpace()
    {
        ...
        // Test Case 3: Negative asteroid wins after multiple collisions
        // $this->assertEquals([-10], $solution->space([10, 2, -5, -10]));
        // Test Case 4: No collisions (already moving apart)
        ...
        // Test Case 6: Multiple same negative asteroids
        // $this->assertEquals([-5, -5], $solution->space([5, -5, -5]));

        // Test Case 7: Opposite directions but no collision
        $this->assertEquals([-10, 5], $solution->space([-10, 5]));

        // Additional test cases
        // $this->assertEquals([-3, -3], $solution->space([3, -3, -3]));
