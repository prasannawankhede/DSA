...
use App\Algorithms\InsertionSortAlgorithm;

class InsertionSortAlgorithmTest extends TestCase
{
    private InsertionSortAlgorithm $insertionSort;

    protected function setUp(): void
    {
        $this->insertionSort = new InsertionSortAlgorithm();
    }
    ...
    public function testSortWithUnsortedArray()
    {
        ...
        $this->assertSame($expected, $this->insertionSort->sort($arr));
    }
